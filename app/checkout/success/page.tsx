...
export default function CheckoutSuccess() {
  return (
    <section className="mx-auto max-w-3xl px-4 py-20 text-center sm:px-6 lg:px-8">
      ...
      <h1 className="mt-6 text-4xl font-black text-camhe-black">Pago registrado</h1>
      <p className="mt-4 text-lg leading-8 text-neutral-700">
        Gracias. CAMHE Infraestructura validará el pago, disponibilidad, entrega y datos de facturación para continuar con tu pedido.
      </p>
