  ...
  return (
    <section className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 space-y-5 rounded-lg bg-white p-6 text-neutral-700 shadow-sm">
        <p className="leading-7">Las devoluciones se revisan caso por caso conforme al tipo de producto, condición de entrega, estado físico, disponibilidad de proveedor y acuerdos confirmados en la compra o cotización.</p>
        ...
        <p className="leading-7">Los productos están sujetos a disponibilidad y las entregas se coordinan según volumen, zona y tipo de producto. Cualquier reporte debe presentarse con evidencia fotográfica, número de pedido o cotización y descripción del caso.</p>
      </div>
    </section>
  );
}
