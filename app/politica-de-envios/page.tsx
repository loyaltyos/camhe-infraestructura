  ...
  return (
    <section className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 space-y-5 rounded-lg bg-white p-6 text-neutral-700 shadow-sm">
        ...
        <p className="leading-7">Los pagos en línea, cuando estén disponibles, se procesan mediante Conekta; la entrega seguirá sujeta a validación de pago, disponibilidad y coordinación logística.</p>
